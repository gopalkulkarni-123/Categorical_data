...
def define_options_parser():
    ...
    parser.add_argument('--modelname', type=str, default = 'airplane_gen_model_v7', help='Model name for saving checkpoints.')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = AirplaneData(dataset_airplanes)
    eval_dataset = AirplaneData(dataset_airplanes)
